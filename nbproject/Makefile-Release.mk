...
${OBJECTDIR}/src/Addition.o: src/Addition.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Addition.o src/Addition.cpp

${OBJECTDIR}/src/Advection.o: src/Advection.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Advection.o src/Advection.cpp

${OBJECTDIR}/src/Diffusion.o: src/Diffusion.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Diffusion.o src/Diffusion.cpp

${OBJECTDIR}/src/Divergence.o: src/Divergence.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Divergence.o src/Divergence.cpp

${OBJECTDIR}/src/FileUtils.o: src/FileUtils.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FileUtils.o src/FileUtils.cpp

${OBJECTDIR}/src/Pressure.o: src/Pressure.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Pressure.o src/Pressure.cpp

${OBJECTDIR}/src/Projection.o: src/Projection.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Projection.o src/Projection.cpp
...
${OBJECTDIR}/src/ShaderUtils.o: src/ShaderUtils.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ShaderUtils.o src/ShaderUtils.cpp

${OBJECTDIR}/src/TextureUtils.o: src/TextureUtils.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TextureUtils.o src/TextureUtils.cpp

${OBJECTDIR}/src/Visualization.o: src/Visualization.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Visualization.o src/Visualization.cpp

${OBJECTDIR}/src/glad/glad.o: src/glad/glad.C
	${MKDIR} -p ${OBJECTDIR}/src/glad
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/glad/glad.o src/glad/glad.C
